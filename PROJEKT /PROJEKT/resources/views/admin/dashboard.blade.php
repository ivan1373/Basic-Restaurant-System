      ...
      <div class="container">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><iframe src="http://free.timeanddate.com/clock/i64w40jv/n3278/tlba30/ftb/tt1/tw0/tm1" frameborder="0" width="85" height="18"></iframe>
</span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Jela u Meniu</span>
              <span class="info-box-number">$menisbr</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Broj Rezervacija</span>
